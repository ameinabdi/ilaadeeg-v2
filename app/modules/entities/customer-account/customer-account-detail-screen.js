...
import styles from './customer-account-detail.screen.style';
  ...
  return (
    ...
    <View style={styles.menu}>
        <Left style={styles.left}>
            ...
            <Text  style={styles.leftText}>{ticket?.schedule?.origin?.city}</Text>
        ...
        <Right  style={styles.right}>
            ...
            <Text style={styles.rightText}>{ticket?.schedule?.distination?.city} </Text>
    ...
    <View style={styles.menu}>
        <Left style={styles.left}>
            ...
            <Text  style={styles.leftText}>{moment(ticket?.bookingDate).format('D MMM YY')  }</Text>
        </Left>
        <View style={styles.center}>
        ...
        <Right  style={styles.right}>
        <Text style={styles.rightTitle}>Seats</Text>

             <Text style={styles.rightText}>{ticket?.seats?.map((seat)=>(seat.seat+',')) } </Text>
        </Right>
    </View>
    <View style={styles.menu}>
        <Left style={styles.left}>
        <Text  style={styles.leftTitle}>Departure</Text>
            ...
            <Text  style={styles.leftText}>{moment(ticket?.schedule?.departureTime, "HH:mm").format('h:mm') }</Text>
        </Left>
        <View style={styles.center}>
        ...
        <Text style={styles.rightTitle}>Arrival</Text>
             ...
             <Text style={styles.rightText}>{moment(ticket?.schedule?.arrivalTime, "HH:mm").format('h:mm')} </Text>
        </Right>
    </View>
    <View style={styles.menu}>
        <Left style={styles.left}>
