...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#EFEFF3' : '#EFEFF3',
  ...
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#FFA500' : '#FFA500',
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? '#1eba44' : '#1eba44',
