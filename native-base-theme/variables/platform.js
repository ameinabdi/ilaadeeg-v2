...
export default {
  ...
  // Tab
  tabBarDisabledTextColor: 'white',
  tabDefaultBg: platform === PLATFORM.IOS ? 'white' : '#1FFA500eba44',
  topTabBarTextColor: platform === PLATFORM.IOS ? 'white' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? 'white' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? 'white' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? 'white' : '#fff',
